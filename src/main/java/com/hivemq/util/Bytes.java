...
public class Bytes {
     ...
     * @throws NullPointerException if the passed {@link io.netty.buffer.ByteBuf} is <code>null</code>
     */
     ...
     * @throws NullPointerException if the passed byte[] is <code>null</code>
     */
    ...
    public static int read3ByteInt(final byte @NotNull [] buffer, final int offset) {
    ...
    public static void copy3ByteIntToByteArray(final int i, final byte @NotNull [] bytes, final int offset) {
...
//    }
     ...
     * @return A String containing hexadecimal representation
     */
    public static String asHexString(final byte[] data) {
